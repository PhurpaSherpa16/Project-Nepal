...
export const Content =({className, paragraph, 
    text_align='text-right', justify_align='justify-end',
    image_1='left-30', image_2='left-5', image_3='-left-20',
    ...
    return(
        ...
        className={`h-screen w-screen bg-(--white) flex gap-10 padding_inline_block ${className}`}>
            <div className={`w-full lg:w-4/6 grid place-items-center relative ${image_1}`}>
                ...
                <motion.div className={`size-30 lg:size-60 2xl:size-72 absolute border-3 border-(--white)
                ...
                <motion.div className={`w-60 h-40 lg:h-60 lg:w-100 2xl:h-72 2xl:w-120 overflow-hidden absolute border-3 border-(--white) bottom-0 ${image_3}`}
                    style={{y: imageFly3}}>
            ...
            <div className='lg:w-3/6 h-full flex flex-col gap-4 justify-end'>
                ...
                <Heading text1={title1} text2={title2} text3={title3} className={`text-black ${text_align}`}/>
